class Admin::CompaniesController < Admin::AdminSiteController
  ...
  def index
    ...
    sort = parse_sort_param(:name, :creator_id, :creator, :unlimited, :company_email_domains, :trial_ends_at, :credit, :payment_error, :subscriptions_count, :minimum_subscription_users)
    sort ||= '-id'
