class Task < ApplicationRecord
  ...
  attr_accessible :name, :objective, :objective_id, :description, :responsible, :responsible_id, :reminder, :status,
    ...
    :hoshin_id, :feeling, :confidence, :impact, :effort, :task_tags, :hidden
  ...
  before_save do |task|        
    ...
    if task.show_on_parent && task.objective.parent_id.present?
      task.parent_area_id = task.objective.parent._?.area_id
      task.parent_objective_id = task.objective.parent._?.id
    else
