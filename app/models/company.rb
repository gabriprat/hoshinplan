class Company < ApplicationRecord
  ...
  index [:deleted_at]
  attr_accessible :name, :creator, :creator_id, :unlimited, :company_email_domains, :trial_ends_at, :credit, :payment_error, :subscriptions_count, :minimum_subscription_users
