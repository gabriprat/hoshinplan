class AddMinimumSubscriptionUsers < ActiveRecord::Migration
  def self.up
    add_column :companies, :minimum_subscription_users, :integer
  ...
  def self.down
    remove_column :companies, :minimum_subscription_users
