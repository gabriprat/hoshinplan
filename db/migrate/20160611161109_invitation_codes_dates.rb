class InvitationCodesDates < ActiveRecord::Migration
  def self.up
    ...
    add_column :invitation_codes, :start_at, :date, :null => false
    add_column :invitation_codes, :end_at, :date, :null => false
  end
  ...
  def self.down
    ...
    remove_column :invitation_codes, :start_at
    remove_column :invitation_codes, :end_at
  end
end
