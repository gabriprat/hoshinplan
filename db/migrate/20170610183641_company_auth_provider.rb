class CompanyAuthProvider < ActiveRecord::Migration
  def self.up
    add_column :auth_providers, :company_id, :integer
    ...
    add_index :auth_providers, [:company_id]
  end

  def self.down
    remove_column :auth_providers, :company_id
    ...
    remove_index :auth_providers, :name => :index_auth_providers_on_company_id rescue ActiveRecord::StatementInvalid
  end
end
