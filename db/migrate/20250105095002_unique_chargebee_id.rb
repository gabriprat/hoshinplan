class UniqueChargebeeId < ActiveRecord::Migration
  def self.up
    ...
    add_index :billing_details, [:chargebee_id], :unique => true
  end
  ...
  def self.down
    ...
    remove_index :billing_details, :name => :index_billing_details_on_chargebee_id rescue ActiveRecord::StatementInvalid
  end
end
