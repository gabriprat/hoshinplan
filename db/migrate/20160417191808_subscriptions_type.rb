class SubscriptionsType < ActiveRecord::Migration
  def self.up
    ...
    add_column :subscriptions, :type, :string, :default => 'SubscriptionPaypal'
  ...
  def self.down
    ...
    remove_index :subscriptions, :name => :index_subscriptions_on_type rescue ActiveRecord::StatementInvalid
  end
end
