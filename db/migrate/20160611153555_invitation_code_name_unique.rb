class InvitationCodeNameUnique < ActiveRecord::Migration
  def self.up
    ...
    change_column :invitation_codes, :name, :string, :null => false
    change_column :invitation_codes, :total, :integer, :null => false
    change_column :invitation_codes, :used, :integer, :null => false
    change_column :invitation_codes, :trial_days, :integer, :null => false
  end
  ...
  def self.down
    ...
    change_column :invitation_codes, :name, :string
    change_column :invitation_codes, :total, :integer
    change_column :invitation_codes, :used, :integer
    change_column :invitation_codes, :trial_days, :integer
  end
end
