class TrialEndsAt < ActiveRecord::Migration
  def self.up
    ...
    add_column :companies, :trial_ends_at, :date
  ...
  def self.down
    ...
    remove_column :companies, :trial_ends_at
    ...
    change_column :companies, :credit, :decimal, precision: 8, scale: 2
