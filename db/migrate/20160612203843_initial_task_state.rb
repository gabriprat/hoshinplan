class InitialTaskState < ActiveRecord::Migration
  def self.up
    add_column :users, :initial_task_state, :string, :default => :backlog, :null => false
  ...
  def self.down
    remove_column :users, :initial_task_state
    change_column :users, :administrator, :boolean, default: false
    change_column :users, :preferred_view, :string, default: "expanded"
