class AddBillingDetailToInvoices < ActiveRecord::Migration
  def self.up
    add_column :invoices, :billing_detail_id, :integer
    ...
    add_index :invoices, [:billing_detail_id]
  end

  def self.down
    remove_column :invoices, :billing_detail_id
    ...
    remove_index :invoices, :name => :index_invoices_on_billing_detail_id rescue ActiveRecord::StatementInvalid
  end
end
