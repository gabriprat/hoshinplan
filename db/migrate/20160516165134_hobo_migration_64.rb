class HoboMigration64 < ActiveRecord::Migration
  def self.up
    ...
    rename_column :billing_details, :validated, :vies_valid
  ...
  def self.down
    ...
    rename_column :billing_details, :vies_valid, :validated
    change_column :billing_details, :validated, :boolean, default: false
