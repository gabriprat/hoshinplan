class HiddenByDefault < ActiveRecord::Migration
  def self.up
    ...
    add_column :indicators, :hidden, :boolean, :default => false, :null => false
    ...
    add_column :objectives, :hidden, :boolean, :default => false, :null => false
  ...
  def self.down
    ...
    remove_column :indicators, :hidden
    change_column :indicators, :goal, :decimal, default: 100.0
    ...
    remove_column :objectives, :hidden
    change_column :objectives, :neglected, :boolean, default: false
    change_column :objectives, :blind, :boolean, default: true

    remove_column :tasks, :hidden
    change_column :tasks, :reminder, :boolean, default: true
    ...
    remove_index :tags, :name => :index_tags_on_goal_id rescue ActiveRecord::StatementInvalid
  end
end
