class HealthHistoriesCompany < ActiveRecord::Migration
  def self.up
    ...
    add_column :health_histories, :company_id, :integer, :null => false

    add_index :health_histories, [:hoshin_id, :day], :unique => true
    add_index :health_histories, [:company_id]
  end
  ...
  def self.down
    ...
    remove_column :health_histories, :company_id

    remove_index :health_histories, :name => :index_health_histories_on_hoshin_id_and_day rescue ActiveRecord::StatementInvalid
    remove_index :health_histories, :name => :index_health_histories_on_company_id rescue ActiveRecord::StatementInvalid
  end
end
