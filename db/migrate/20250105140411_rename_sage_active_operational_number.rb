class RenameSageActiveOperationalNumber < ActiveRecord::Migration
  def self.up
    rename_column :invoices, :chargebee_invoice_id, :sage_active_operational_number
    ...
    #add_index :invoices, [:sage_active_operational_number], :unique => true
  end

  def self.down
    rename_column :invoices, :sage_active_operational_number, :chargebee_invoice_id
    ...
    #remove_index :invoices, :name => :index_invoices_on_sage_active_operational_number rescue ActiveRecord::StatementInvalid
