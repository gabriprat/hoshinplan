class IndicatorEvents < ActiveRecord::Migration
  def self.up
    ...
    add_index :indicator_events, [:indicator_id, :day], :unique => true
    add_index :indicator_events, [:creator_id]
    add_index :indicator_events, [:company_id]
    add_index :indicator_events, [:indicator_id]
