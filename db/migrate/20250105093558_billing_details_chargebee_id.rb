class BillingDetailsChargebeeId < ActiveRecord::Migration
  def self.up
    change_column :sage_active_countries, :name, :string, :null => true
    change_column :sage_active_countries, :iso_code_alpha2, :string, :null => true
    change_column :sage_active_countries, :iso_code_alpha3, :string, :null => true
    change_column :sage_active_countries, :iso_number, :string, :null => true
    change_column :sage_active_countries, :creationDate, :datetime, :null => true
    change_column :sage_active_countries, :modificationDate, :datetime, :null => true
    ...
    add_column :billing_details, :chargebee_id, :string
    ...
    add_column :chargebee_customers, :sage_active_id, :string
  end

  def self.down
    change_column :sage_active_countries, :name, :string, null: false
    change_column :sage_active_countries, :iso_code_alpha2, :string, null: false
    change_column :sage_active_countries, :iso_code_alpha3, :string, null: false
    change_column :sage_active_countries, :iso_number, :string, null: false
    change_column :sage_active_countries, :creationDate, :datetime, null: false
    change_column :sage_active_countries, :modificationDate, :datetime, null: false
    ...
    remove_column :billing_details, :chargebee_id
    change_column :billing_details, :vies_valid, :boolean, default: false

    change_column :billing_plans, :min_users, :integer, default: 5, null: false

    remove_column :chargebee_customers, :sage_active_id
  end
end
