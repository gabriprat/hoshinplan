class SubscriptionsAndBillingDetails < ActiveRecord::Migration
  def self.up
    ...
    remove_column :billing_details, :plan_name
    remove_column :billing_details, :price_per_user
    remove_column :billing_details, :billing_period
    remove_column :billing_details, :currency
    remove_column :billing_details, :monthly_price_per_user
    remove_column :billing_details, :users
    ...
    add_column :subscriptions, :monthly_value, :decimal, :precision => 8, :scale => 2
    add_column :subscriptions, :billing_period, :string
    add_column :subscriptions, :billing_detail_id, :integer
    remove_column :subscriptions, :token
    remove_column :subscriptions, :billing_plan_id
    ...
    add_index :subscriptions, [:billing_detail_id]
  end
  ...
  def self.down
    ...
    add_column :billing_details, :plan_name, :string
    add_column :billing_details, :price_per_user, :decimal
    add_column :billing_details, :billing_period, :string
    add_column :billing_details, :currency, :string
    add_column :billing_details, :monthly_price_per_user, :decimal
    add_column :billing_details, :users, :integer
    ...
    remove_column :subscriptions, :monthly_value
    remove_column :subscriptions, :billing_period
    remove_column :subscriptions, :billing_detail_id
    add_column :subscriptions, :token, :string
    add_column :subscriptions, :billing_plan_id, :integer
    change_column :subscriptions, :status, :string

    remove_index :subscriptions, :name => :index_subscriptions_on_billing_detail_id rescue ActiveRecord::StatementInvalid
