class TasksVisibleDays < ActiveRecord::Migration
  def self.up
    ...
    add_column :hoshins, :tasks_visible_days, :integer, :default => 110, :null => false
    ...
    add_column :tasks, :visible_days, :integer, :default => 110, :null => false
  ...
  def self.down
    ...
    remove_column :hoshins, :tasks_visible_days
