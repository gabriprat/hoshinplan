class HoshinImage < ActiveRecord::Migration
  def self.up
    change_column :users, :administrator, :boolean, :default => false
    change_column :users, :preferred_view, :string, :default => :expanded
    change_column :users, :payments_count, :integer, :null => false, :default => 0

    add_column :hoshins, :image_file_name, :string
    add_column :hoshins, :image_content_type, :string
    add_column :hoshins, :image_file_size, :integer
    add_column :hoshins, :image_updated_at, :datetime
  ...
  def self.down
    ...
    remove_column :hoshins, :image_file_name
    remove_column :hoshins, :image_content_type
    remove_column :hoshins, :image_file_size
    remove_column :hoshins, :image_updated_at
