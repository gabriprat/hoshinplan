class NotNullCompanyEmailDomain < ActiveRecord::Migration
  def self.up
    ...
    change_column :company_email_domains, :company_id, :integer, :null => false
  end
  ...
  def self.down
    ...
    change_column :company_email_domains, :company_id, :integer
  end
end
