class Invoices2 < ActiveRecord::Migration
  def self.up
    rename_column :invoices, :amount, :total_amount
    add_column :invoices, :net_amount, :decimal, :precision => 8, :scale => 2
    add_column :invoices, :tax_tpc, :decimal, :precision => 8, :scale => 2
  ...
  def self.down
    ...
    remove_column :invoices, :net_amount
    remove_column :invoices, :tax_tpc
