class HoboMigration52 < ActiveRecord::Migration
  def self.up
    ...
    remove_index :indicator_events, :name => :index_indicator_events_on_indicator_id_and_day rescue ActiveRecord::StatementInvalid
    add_index :indicator_events, [:indicator_id, :day]
  end
