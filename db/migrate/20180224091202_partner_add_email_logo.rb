class PartnerAddEmailLogo < ActiveRecord::Migration
  def self.up
    ...
    add_column :partners, :email_logo_file_name, :string
    add_column :partners, :email_logo_content_type, :string
    add_column :partners, :email_logo_file_size, :integer
    add_column :partners, :email_logo_updated_at, :datetime
  ...
  def self.down
    ...
    remove_column :partners, :email_logo_file_name
    remove_column :partners, :email_logo_content_type
    remove_column :partners, :email_logo_file_size
    remove_column :partners, :email_logo_updated_at
    change_column :partners, :companies_trial_days, :integer, default: 90
