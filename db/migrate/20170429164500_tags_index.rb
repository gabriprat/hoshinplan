class TagsIndex < ActiveRecord::Migration
  def self.up
    ...
    remove_index :tags, :name => :index_tags_on_label rescue ActiveRecord::StatementInvalid
    add_index :tags, [:hoshin_id, :label]
  end
  ...
  def self.down
    ...
    remove_index :tags, :name => :index_tags_on_hoshin_id_and_label rescue ActiveRecord::StatementInvalid
