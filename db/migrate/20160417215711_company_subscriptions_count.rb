class CompanySubscriptionsCount < ActiveRecord::Migration
  def self.up
    ...
    add_column :companies, :subscriptions_count, :integer, :default => 0, :null => false
    ...
    change_column :subscriptions, :type, :string, :default => nil
  end
  ...
  def self.down
    ...
    remove_column :companies, :subscriptions_count
    ...
    change_column :subscriptions, :type, :string, default: "SubscriptionPaypal"
  end
end
