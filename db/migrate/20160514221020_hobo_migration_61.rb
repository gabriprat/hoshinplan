class HoboMigration61 < ActiveRecord::Migration
  def self.up
    ...
    add_column :subscriptions, :last_payment_at, :datetime
    add_column :subscriptions, :next_payment_at, :datetime
  ...
  def self.down
    ...
    remove_column :subscriptions, :last_payment_at
    remove_column :subscriptions, :next_payment_at
