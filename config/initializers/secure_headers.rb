::SecureHeaders::Configuration.default do |config|
  ...
  config.csp = {
    ...
    :frame_src => %w('self' accounts.google.com docs.google.com *.userreport.com www.youtube.com"),
    :style_src => %w('self' 'unsafe-inline' fonts.googleapis.com static.hoshinplan.com staticdoc.hoshinplan.com),
    :script_src => %w('self' 'unsafe-eval' 'unsafe-inline' static.hoshinplan.com staticdoc.hoshinplan.com apis.google.com www.dropbox.com app.box.com *.userreport.com settingsbucket.s3.amazonaws.com www.google-analytics.com ajax.cloudflare.com cdn.mxpnl.com),
