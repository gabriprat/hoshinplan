::SecureHeaders::Configuration.default do |config|
  ...
  config.csp = {
    ...
    :report_only => false,
    :connect_src => %w('self' performance.typekit.net d4i78hkg1rdv3.cloudfront.net *.hoshinplan.com ws://*.hoshinplan.com ws://*.hoshinplandev.com:5000 *.userreport.com api.mixpanel.com sqs.us-east-1.amazonaws.com),
