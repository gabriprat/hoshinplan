::SecureHeaders::Configuration.configure do |config|
  ...
  config.csp = {
    ...
    :frame_src => "'self' accounts.google.com docs.google.com *.userreport.com www.youtube.com",
    ...
    :img_src => "'self' doc.hoshinplan.com static.hoshinplan.com staticdoc.hoshinplan.com hoshinplan.s3-eu-west-1.amazonaws.com shield.sitelock.com cdn.mxpnl.com stats.g.doubleclick.net www.google-analytics.com *.userreport.com sqs.us-east-1.amazonaws.com sha1test.cloudflaressl.net sha2test.cloudflaressl.net",
