::SecureHeaders::Configuration.configure do |config|
  ...
  config.csp = {
    ...
    :img_src => "self static.hoshinplan.com staticdoc.hoshinplan.com hoshinplan.s3-eu-west-1.amazonaws.com shield.sitelock.com cdn.mxpnl.com stats.g.doubleclick.com www.google-analytics.com",
