::SecureHeaders::Configuration.default do |config|
  ...
  config.csp = {
    ...
    :img_src => %w('self' data: q.stripe.com p.typekit.net ping.typekit.net doc.hoshinplan.com d4i78hkg1rdv3.cloudfront.net static.hoshinplan.com staticdoc.hoshinplan.com hoshinplan.s3-eu-west-1.amazonaws.com shield.sitelock.com *.mxpnl.com stats.g.doubleclick.net www.google-analytics.com *.userreport.com sqs.us-east-1.amazonaws.com),
